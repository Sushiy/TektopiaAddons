...
public class EntityAIAttackRangedBow2<T extends EntityCreature & IRangedAttackMob> extends EntityAIBase
{
    ...
    public EntityAIAttackRangedBow2(T creature, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn)
    {
